...
@section('page_subtitle', 'Buat kategori baru untuk kegiatan DKM AL HIKMAH')
...
<div class="form-page-header">
    <div>
        ...
        <p class="form-subtitle">
            Isi data kategori yang akan digunakan untuk mengelompokkan kegiatan di halaman publik DKM AL HIKMAH.
        </p>
    </div>
        ...
        <div class="admin-form-grid">
            ...
            <div>
                ...
                <div class="admin-form-help">
                    Boleh dikosongkan. Sistem akan membuat slug otomatis dari nama kategori.
                </div>
            ...
            <div class="admin-form-group-full">
                ...
                <textarea id="desc"
                          ...
                          rows="5"
                          class="admin-form-control"
                          placeholder="Tulis deskripsi singkat kategori...">{{ old('desc') }}</textarea>
