...
@section('content')
                ...
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-12 order-lg-1">
                        ...
                        <div class="d-flex gap-3 mt-4">
                            <a href="{{ route('profil.index') }}" class="button button-lg button-radius button-white shadow">Tentang Kami</a>
                            <a href="{{ route('kegiatan.index') }}" class="button button-lg button-radius button-outline-white">Kegiatan Rutin</a>
                        </div>
    ...
    <div id="kegiatan" class="section">
        <div class="container">
            ...
            <div class="section-title text-center mb-5">
                <h6 class="font-small uppercase text-dkm-blue letter-spacing-1">Dokumentasi</h6>
    ...
    <div id="profil" class="section">
        <div class="container">
            <div class="row align-items-center g-5">
                ...
                <div class="col-12 col-lg-6">
                    <h6 class="font-small uppercase text-dkm-blue letter-spacing-1">Profil Masjid</h6>
                    ...
                    <div class="row g-2 mt-3">
                        <div class="col-6"><i class="bi bi-check-circle text-dkm-blue me-2"></i> Berdiri Sejak 19xx</div>
                        <div class="col-6"><i class="bi bi-check-circle text-dkm-blue me-2"></i> Kapasitas 1000+ Jamaah</div>
                    </div>
    ...
    <div class="section-xl bg-image parallax" data-bg-src="{{ asset('assets/images/dkm/parallax-bg.jpg') }}">
        <div class="position-relative overflow-hidden"
            style="padding: 110px 0; background: linear-gradient(180deg, rgba(30, 64, 175, 0.92) 0%, rgba(37, 99, 235, 0.86) 55%, rgba(14, 165, 233, 0.78) 100%);">
            ...
            <div class="container position-relative text-center text-white">
                <div class="row">
                    <div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                        ...
                        <h1 class="display-4 font-family-outfit fw-bold mb-3 text-white">
